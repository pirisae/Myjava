...
public class inheTest04 {
    static void main(String[] args) {
        // 승급 : 낮은 등급의 클래스가 높은 등급의 클래스 타입으로 한시적 형태가 바뀌는 동작
        ...
        Espresso04 coffe2 = (Espresso04) beverage02;
        coffe2.drinkEspresso();
